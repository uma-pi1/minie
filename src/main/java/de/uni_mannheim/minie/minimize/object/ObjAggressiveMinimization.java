...
public class ObjAggressiveMinimization {
    ...
    public static void minimizeObject(AnnotatedPhrase object, SemanticGraph sg){
        ...
        String seqPosNer = CoreNLPUtils.wordsToPosMergedNerSeq(object.getWordList());
        ...
        object.addDroppedEdges(CoreNLPUtils.listOfIndexedWordsToParentEdges(sg, dropWords));
